  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Experienced Full-Stack Developer & AI & Data Science Enthusiast
        </motion.h2>
        ...
        >
        Building intelligent, scalable, and user-centric software solutions by combining modern web technologies with data-driven innovation.
        </motion.p>
        ...
        >
          <Badge className="text-xs bg-pink-500">Core Developer</Badge>
